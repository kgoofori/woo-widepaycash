...
1.	You need to have a Widepaycash Merchant Account.
...
You can raise a support ticket [here](https://wordpress.org/support/plugin/woo-widepaycash-payments-gateway).
